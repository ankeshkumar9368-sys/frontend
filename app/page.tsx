                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ _jsxs("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /* Referral Wallet Card in Profile Tab */
                                                    /*#__PURE__*/ _jsxs("div", {
                                                        className: "mt-3 w-full max-w-xs overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 p-[1.5px] shadow-xl shadow-emerald-500/20 transition-all hover:scale-[1.01] active:scale-[0.98] cursor-pointer",
                                                        onClick: () => setShowReferralCenter(true),
                                                        children: [
                                                            /*#__PURE__*/ _jsxs("div", {
                                                                className: "flex items-center justify-between gap-3 rounded-[15px] bg-slate-950 px-4 py-3 text-left text-white",
